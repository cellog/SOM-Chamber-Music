<?php
namespace SOM\Model;
class InstrumentsForPlayWithTheChiaras extends \Chiara\PodioItem
{
    protected $MYAPPID=6505423;
    function __construct($info = null, $retrieve = true)
    {
        parent::__construct($info, new \SOM\Model\Structure\InstrumentsForPlayWithTheChiaras, $retrieve);
    }
