<?php
namespace SOM\Model;
class TeachingArtistDates extends \Chiara\PodioItem
{
    protected $MYAPPID=6558188;
    function __construct($info = null, $retrieve = true)
    {
        parent::__construct($info, new \SOM\Model\Structure\TeachingArtistDates, $retrieve);
    }
