<?php
namespace SOM\Model;
class GroupsRehearsalClass extends \Chiara\PodioItem
{
    protected $MYAPPID=6521127;
    function __construct($info = null, $retrieve = true)
    {
        parent::__construct($info, new \SOM\Model\Structure\GroupsRehearsalClass, $retrieve);
    }
